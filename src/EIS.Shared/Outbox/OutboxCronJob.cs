...
internal sealed class OutboxCronJob : CronJobService
{
    private readonly IServiceProvider _serviceProvider;
    private readonly DeduplicationOptions _options;

    public OutboxCronJob(ICronConfiguration<DeduplicationCronJob> cronConfiguration, IServiceProvider serviceProvider,
