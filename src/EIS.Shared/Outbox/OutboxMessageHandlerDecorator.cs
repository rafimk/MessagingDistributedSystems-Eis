...
internal sealed class OutboxMessageHandlerDecorator<TMessage> : IMessageHandler<TMessage> where TMessage : class, IMessage
{
    private readonly IMessageHandler<TMessage> _handler;
    private readonly IMessageIdAccessor _messageIdAccessor;
    private readonly DbContext _dbContext;

    public OutboxMessageHandlerDecorator(IMessageHandler<TMessage> handler, Func<DbContext> getContext, 
